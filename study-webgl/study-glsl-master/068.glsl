...
// Serves no other purpose than to save having to write this out all the u_time. I could write a
...
void main( void ){
	...
	vec2 uv = gl_FragCoord/iu_resolution.xy; // Screen coordinates. Range: [0, 1]
  vec2 pw = 1./iu_resolution.xy; // Relative pixel width. Used for neighboring pixels, etc.
