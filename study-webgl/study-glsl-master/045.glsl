...
float distanceFunc(vec3 p){
  ...
  // rotate
  vec3 r = rotate(p, radians(u_time * 50.0), vec3(1.0, 1.0, 0.0));
  ...
  float d2 =
    sin(5.0 * p.x + (u_time * 0.2) * 12.0) *
    cos(5.0 * p.y + (u_time * 0.2) * 14.0) *
    sin(5.0 * p.z + (u_time * 0.2) * 20.0);

  float d3 =
    sin(4.0 * p.x + (u_time * 0.04) * 2.0) *
    cos(4.0 * p.y + (u_time * 0.04) * 2.0) *
    sin(4.0 * p.z + (u_time * 0.04) * 2.0);
