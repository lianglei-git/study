...
float distanceFunc(vec3 p){
  ...
  // displamaent
  float d1 =
    sin(4.0 * p.x + (u_time * 2.0)) *
    cos(4.0 * p.y + (u_time * 2.0)) *
    sin(4.0 * p.z + (u_time * 2.0));

  // boxel
  float d2 =
    mod(sin(4.0 * p.x + (u_time * 0.5)), 0.8) *
    mod(cos(4.0 * p.y + (u_time * 0.5)), 0.8) *
    mod(sin(4.0 * p.z + (u_time * 0.5)), 0.8);
